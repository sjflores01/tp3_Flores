...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <asp:Label Text="Hola " CssClass="display-3" ID="lblBienvenida" runat="server" />
        </div>
    </div>
    <div class="container">
        <div class="row">
            <asp:Label Text="Tu carrito no tiene items! 
                ...
                ID="lblCarritoVacio" CssClass="display-4" runat="server" />
        </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="Carrito.aspx?cArt=<% = item.Codigo %>">
